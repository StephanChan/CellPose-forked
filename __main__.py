...
def main():
    ...
    input_img_args.add_argument('--image_path',
                        default=[r'C:\Users\ScanImage\CellCounting\final\1-BF.tif'], type=str, help='if given and --dir not given, run on single image instead of folder (cannot train with this option)')
